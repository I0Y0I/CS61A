...
class BankAccount:
    ...
    def deposit(self, amount):
        ...
        """
        self.transactions.append(Transaction(self.transactions_id, self.balance, self.balance + amount))
    ...
    def withdraw(self, amount):
        ...
        if amount > self.balance:
            self.transactions.append(Transaction(self.transactions_id, self.balance, self.balance))
            self.transactions_id += 1
...
class Coin:
    ...
    def worth(self):
        "*** YOUR CODE HERE ***"
        age = Mint.present_year - self.year - 50
