...
class Button:
    ...
    def press(self):
        ...
        self.pressed += 1
        "*** YOUR CODE HERE ***"
        self.output(self.letter.upper() if self.caps_lock.pressed & 1 else self.letter)
        return self
...
class Keyboard:
    ...
    def __init__(self):
        self.typed = []
        self.keys = {i : Button(i, lambda x: self.typed.append(x)) for i in LOWERCASE_LETTERS}  # Try a dictionary comprehension!
